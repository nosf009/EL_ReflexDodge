...
{
    /// <summary>
    /// Difficulty/time mapping for Grid Swipe (8-puzzle).
    /// Registers into the global KiqqiLevelManager automatically.
    /// </summary>
    public class KiqqiGridSwipeLevelManager : MonoBehaviour, IKiqqiSubLevelManager
    {
        [Header("Difficulty Ranges (GridSwipe)")]
